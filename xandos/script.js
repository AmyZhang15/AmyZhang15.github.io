...
function checkWin(){
	...
	if(board.b3.value == board.b4.value && board.b4.value == board.b5.value && board.b3.value !=""){
		announceWin(board.b3.value);
	}
	if(board.b6.value == board.b7.value && board.b7.value == board.b8.value && board.b6.value !=""){
		announceWin(board.b6.value);
	}
	if(board.b0.value == board.b3.value && board.b3.value == board.b6.value && board.b0.value !=""){
		announceWin(board.b0.value);
	}
	if(board.b1.value == board.b4.value && board.b4.value == board.b7.value && board.b1.value !=""){
		announceWin(board.b1.value);
	}
	if(board.b2.value == board.b5.value && board.b5.value == board.b8.value && board.b2.value !=""){
		announceWin(board.b2.value);
	}
	if(board.b0.value == board.b4.value && board.b4.value == board.b8.value && board.b0.value !=""){
		announceWin(board.b0.value);
	}
	if(board.b2.value == board.b4.value && board.b4.value == board.b6.value && board.b2.value !=""){
		announceWin(board.b2.value);
	}
	else if(plays ==9){
		announceCatsGame();
